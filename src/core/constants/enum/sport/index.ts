...
export enum EPollIntervalGuardKeys {
  ...
  LAEGUE_TAG_STATISTICS = 'sport/get-league-tag-list',
}
...
export const ALL_MATCH_TYPES: Array<{ code: EMatchTypes, name: string, shortName?: string }> = [
  ...
  },
  {
    ...
    name: process.env.CLIENT_MODE === 'mobile' ? '进行中' : '滚球盘',
    shortName: '滚球',
  },
  {
  ...
  // todo 隐藏冠军玩法
  {
    code: EMatchTypes.CHAMPION,
    name: '冠军',
    shortName: '冠军',
  },
  {
    code: EMatchTypes.PARLAY,
    name: '串关',
    shortName: '串关',
  },
];
...
// 注单结果, -1:无效 0:无结果, 2:走水, 3:输, 4:赢, 5:赢一半, 6:输一半, 7:赛事取消, 8:赛事延期, 11:比赛延迟, 12:比赛中断, 13:未知, 15:比赛放弃, 16:异常盘口, 17:未知赛事状态, 18:比赛取消, 19:比赛延期
...
export const BET_RESULT_TYPE_MAP: { [key in EBetResultType]: string } = {
  ...
  [EBetResultType.ROLLBACK]: '回滚',
  [EBetResultType.AUTO_CANCEL]: '预约失效',
  [EBetResultType.HANDLE_CANCEL]: '注单取消',
  [EBetResultType.CANCELL]: '注单取消',
  [EBetResultType.FLAT_MATCH_ROLLBACK]: '走水', // 比分回滚取消结算返还金额,算走水
  [EBetResultType.RISK_ORDER_REJECT]: '注单无效', // 风控拒单
};
