...
import {EStaticsScoreType, EStaticsType, useOtherScoreIds} from '@core/constants/enum/sport';
        ...
        <div className="score">
          {
            !match.matchClock.period ?
              ...
              <div className="score-num">
                {useOtherScoreIds.includes(match.sportId) ? `${match.score.otherScore?.set?.h ?? ''} : ${match.score.otherScore?.set?.a ?? ''}` : `${match.score.home ?? ''} : ${match.score.away ?? ''}`}
              </div>
          }
        </div>
        <div className="logo">
...
const InPlayComp = ({match}: IScoreCompProp) => {
  ...
  const {detailUpdateTime} = useSelector((state: TStore) => state.sport.display);
  ...
  const getRender = () => {
    ...
    switch (match.sportId) {
        ...
        return (
          <div className="score-table">
            ...
            <div className="col-item">
              ...
              <div className="item">{matchDetailStatistics?.hometTeamHalfTimeScore || 0}</div>
            ...
            <div className="col-item">
              ...
              <div className="item">{matchDetailStatistics?.awayTeamHalfTimeScore || 0}</div>
      ...
      case 2:
        ...
        const h1 = getBasketballScore('1h');
        const h2 = getBasketballScore('2h');
        return (
          <div className="score-table ">
            <div className="col-item">
              ...
              </div>
              {
                match.spt === 2 ?
                <>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '1H'})}>上半场</div>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '2H'})}>下半场</div>
                </> :
                <>
            ...
            <div className="col-item">
              ...
              </div>
              {
                match.spt === 2 ?
                <>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '1H'})}>{h1[0]}</div>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '2H'})}>{h2[0]}</div>
                </> :
                <>
            ...
            <div className="col-item">
              ...
              </div>
              {
                match.spt === 2 ?
                <>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '1H'})}>{h1[1]}</div>
                  <div className={classnames('item', {'text-primary': match.score.otherScore.cpc?.toUpperCase() === '2H'})}>{h2[1]}</div>
                </> :
                <>
        ...
        return (
          <div className="score-table">
            ...
            <div className="col-item">
              ...
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[0]?.h || 0}</div>
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[1]?.h || 0}</div>
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[2]?.h || 0}</div>
              <div className="item">{match.score.otherScore?.set?.h || 0}</div>
              <div className="item">{match.score.home || 0}</div>
            </div>
            <div className="col-item">
              <div className="title">
                <DpImage size={24} width={24} type="team" src={match.teams.away.icon} />
              ...
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[0]?.a || 0}</div>
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[1]?.a || 0}</div>
              <div className={classnames('item')}>{(match.score.otherScore?.periods ?? [])[2]?.a || 0}</div>
              <div className="item">{match.score.otherScore?.set?.a || 0}</div>
              <div className="item">{match.score.away || 0}</div>
            </div>
          </div>
        );
      default:
