// @ts-nocheck
import conrnerKickDark from './i/2_dark.png';
import conrnerKickLight from './i/2.png';
...
import timer from './i/timer.webp';
...
export const iconType = (theme: string, type: string)=>{
  switch (type) {
    ...
    case '21': // 红黄牌
      return theme ==='light' ? redRellowCard : redRellowCard;
    case '22': // 红牌
