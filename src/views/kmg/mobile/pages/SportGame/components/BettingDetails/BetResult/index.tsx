...
import {ESportType, EStaticsType, EStaticsTypeName} from '@core/constants/enum/sport';
...
import DpMatchEvent from './components/MatchEvent';
...
import jq from './components/MatchEvent/i/jiao-qiu.svg';
import shotsOnGoal from './components/MatchEvent/i/12_dark.webp';
import penalties from './components/MatchEvent/i/37_dark.webp';
...
const basketballResult = [
  {
    score: '暂停',
    icon: require('./components/MatchEvent/i/zhan-ting.svg'),
  },
  {
    score: '犯规',
    icon: require('./components/MatchEvent/i/fan-gui-b.svg'),
  },
  {
    score: '进球',
    icon: require('./components/MatchEvent/i/er-fen-de-fen.svg'),
  },
  {
    score: '未中',
    icon: require('./components/MatchEvent/i/fa-qiu-wei-zhong.svg'),
  },
  {
    score: '罚球',
    icon: require('./components/MatchEvent/i/fa-qiu.svg'),
  },
];
          ...
          <div className='event'>
            ...
            >
              ...
              <div className='event-result'>
                {
                  matchDetail?.sportId === ESportType.FOOTBALL &&
                      ...
                      matchResults.map((item, idx) => {
                        return (
                          <div key={idx} className='event-item'>
                            <div>
                              {
                                item.icon ? <img src={item.icon} className='event-img'/>:
                                <img src={require(`./i/${item.type}${theme === ETHEME.DARK ? '_dark' : ''}.webp`)} className='event-img'/>
                              }
                            </div>
