...
import GoalDistributionDetail from './components/GoalDistributionDetail';
import BetIndex from './components/BetIndex';
import MarketTrend from './components/NewMarketTrend';
ChartJS.register(
    CategoryScale,
    LinearScale,
    PointElement,
...
export default React.memo(() => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {detailTab === 'ODDS' ? <BetIndex back={(e: TabProps)=>setDetailTab(e)}/> :''}
    </div>
  );
});
