...
const LeagueLists = () => {
      ...
      <div className={styles.wrapper}>
        <div className='header'>
          ...
          >
            ...
            <DpIcon className={classnames('open-icon', isOpen ? 'open' : 'close')} width={12} height={12} type="arrow" fill={isOpen ? mobileTheme.dpNormal : '#fff'} />
          </div>
        </div>
      </div>
    );
  ...
  return (
    <>
      <LeagueSelect />
      <Overlay display={isOpen} zIndex={20} close={close} containerClassname='heightAuto'>
